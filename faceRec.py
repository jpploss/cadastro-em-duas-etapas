...
# VideoCapture: classe do OpenCV responsável por realizar a captura de frames em um vídeo. Passamos o caminho como parâmetro na criação do objeto
# leitura da webcam, precisamos passar o seu ID de referência (em um notebook, o ID da câmera primária é 0)
